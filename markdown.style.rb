...
rule "MD013", :line_length => false # line length should be no more than 80 characters
...
rule "MD030", :ul_single => 1, :ul_multi => 3, :ol_single => 1, :ol_multi => 2 # spaces after list markers
